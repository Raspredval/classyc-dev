...
4. Process ^:
 1. The incoming ^ has the same precedence as the one on the stack, but is right-associative.
 2. Because the condition for popping is "strictly greater precedence," we do not pop the stack.
 3. Push the new ^ onto the stack.
